...
public class FollowerActivity extends Activity implements OnItemClickListener{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String imgsrc = FootTripCommunication.SERVER_URL;
		...
		ArrayList<profile> follwerList = new ArrayList<profile>();
		...
		try {
			...
			for(int i=0;i<contentArr.length();i++){
				...
				follwerList.add(new profile(R.drawable.ic_launcher, content.get("USERNAME").toString()));
		...
		//customAdapter
		ProfilerAdapter myProfilerAdapter = new ProfilerAdapter(this, follwerList);
		// list와 adapter 연결
