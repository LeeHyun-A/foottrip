...
public class MapViewInservice extends FragmentActivity implements OnMapClickListener {
	...
	private void init(String coo1[], String coo2[]) {
		...
		for(int i = 0 ; i < coo1.length; i++){
			...
			GooglePlayServicesUtil.isGooglePlayServicesAvailable(MapViewInservice.this);
